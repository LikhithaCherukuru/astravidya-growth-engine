...
>
  <div className="relative aspect-square max-w-md mx-auto">
    ...
    {/* Glow */}
    <div className="absolute inset-16 rounded-full bg-brand-gradient opacity-30 blur-3xl" />
    ...
    <div className="absolute inset-0 flex items-center justify-center">
      ...
      >
        ...
        <img
          src={logo}
          alt={BRAND_NAME}
          className="relative z-10 h-64 w-64 object-contain drop-shadow-[0_0_30px_rgba(168,85,247,0.45)]"
        />
      </motion.div>
    </div>
  </div>
